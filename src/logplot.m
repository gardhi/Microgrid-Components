...
min_PV = 150;               % Min PV power simulated [kW]
max_PV = 350;               % Max PV power simulated [kW]
step_PV = 5;                % PV power simulation step [kW]
min_batt = 500;             % Min Battery capacity simulated [kWh]
max_batt = 1200;            % Max Battery capacity simulated [kWh]
